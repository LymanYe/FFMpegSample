...
open class BaseFragment: Fragment(), MyRecyclerViewAdapter.ItemClickListener {
    ...
    enum class DATA_TYPE(val text: String){
        ...
        BASIC_FFMPEG_AVCODEC_ENCODE_YUV420P2H264("YUV420P编码为H264"),
        BASIC_FFMPEG_AVCODEC_ENCODE_PCM2AAC("PCMS16LE编码为AAC"),
        BASIC_FFMPEG_AVCODEC_ENCODE_PCM2MP3("PCMS16LE编码为MP3"),
